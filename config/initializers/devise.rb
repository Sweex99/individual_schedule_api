...
Devise.setup do |config|
  ...
  # config.secret_key = 'f49dbb4f4a2091718acec7648a3e8a0fddf7e8c81068fb609478a8c6d34b4a0459c6a72e11b9cc91e2bc0dd56fe4f21fa23e0a14045470370dc3d4f81a3a6c33'
  ...
  # config.pepper = '2e4fecae9b939ea459834bbb38a48204608a70967a130a4ca4c56ed7234e6478dddfe0ae434b69a869e81703e510ae26eab1c3dc0f32b40ba838a876c719f4e6'
  ...
  config.saml_create_user = true              # Дозволити створення користувача, якщо його немає
  config.saml_update_user = true              # Оновлювати дані користувача при кожному вході
  config.saml_default_user_key = :email       # Унікальний ідентифікатор (email)
