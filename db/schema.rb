...
ActiveRecord::Schema[7.1].define(version: 2025_05_04_171039) do
  ...
  create_table "subjects_teachers", force: :cascade do |t|
    ...
    t.bigint "request_id"
    t.string "state"
    t.index ["request_id"], name: "index_subjects_teachers_on_request_id"
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["teacher_id"], name: "index_templates_on_teacher_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "gender"
    t.bigint "group_id"
    t.boolean "grand_teacher", default: false
